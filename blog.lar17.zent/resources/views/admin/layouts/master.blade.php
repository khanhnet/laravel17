...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Khanh</b>NET</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
           ...
           <li><a href="/admin/listPosts"><i class="fa fa-book"></i> <span>Quản lí bài viết</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="">Khánh NET Studio</a>.</strong> All rights
    reserved.
  </footer>
