...
<div class="content col-xs-8">
            ...
            <article>
                <div class="post-image">
                    ...
                    <div class="category"><a href="{{ route('detail',$post->id) }}">IMG</a></div>
                </div>
                <div class="post-text">
                    <span class="date">{{$post->created_at}}</span>
                    <h2><a href="{{ route('detail',$post->id) }}">{{$post->title}}</a></h2>
                    <p class="text">{{$post->created_at}}
                    <a href="{{ route('detail',$post->id) }}"><i class="icon-arrow-right2"></i></a></p>                                 
                </div>
                <div class="post-info">
