		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<div>
						<button data-url="{{route('tags.create')}}" class="btn btn-primary" id="btn-add" style="margin-left: 20px">Thêm mới</button>
					</div>
					<!-- /.box-header -->
					<div class="box-body ">
...
@include('admin.tags.show')


@endsection

@section('footer')
<script type="text/javascript" src="{{ asset('admin_assets/js/custom_tag.js') }}"></script>
@endsection