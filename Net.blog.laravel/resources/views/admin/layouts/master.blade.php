  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>K</b>N</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Khanh net</b> | Admin</span>
      </a>
    ...
    <li class="dropdown user user-menu">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        <img src="{{ Auth::user()->thumbnail }}" class="user-image" alt="User Image">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="user-header">
          <p>
            {{ Auth::user()->name }}
            <small>Hoạt động từ: {{ Auth::user()->created_at }}</small>
          </p>
        </li>
        <!-- Menu Footer-->
...
<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2019 <a href="https://adminlte.io">KN Studio</a>.</strong> All rights
  reserved.
</footer>
